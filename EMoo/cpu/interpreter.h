...
inline void Interpreter::interpretAddRbRmb(Instruction *instruction) {
    ...
    *machine.cpu.registerAddressTable[instruction->reg] = result;
...
inline void Interpreter::interpretAddAlIb(Instruction *instruction) {
    ...
    result = uint8_t(operand1 + operand2);
    *machine.cpu.registerAddressTable[Cpu::AL] = result;
...
inline void Interpreter::interpretAdcRmbRb(Instruction *instruction) {
    ...
    result = uint8_t(operand1 + operand2 + machine.cpu.flagsRegister.getCf());
    *rmAddress = result;
...
inline void Interpreter::interpretAdcRmwRw(Instruction *instruction) {
    ...
    result = uint16_t(operand1 + operand2 + machine.cpu.flagsRegister.getCf());
    *WORD(rmAddress) = result;
...
opAdd:
    result = uint16_t(operand1 + operand2);
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::ADD16);
opOr:
    result = uint16_t(operand1 | operand2);
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::LOG16);
opAdc:
    result = uint16_t(operand1 + operand2 + machine.cpu.flagsRegister.getCf());
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::ADC16);
opSbb:
    result = uint16_t(operand1 - (operand2 + machine.cpu.flagsRegister.getCf()));
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::SBB16);
opAnd8:
    result = uint16_t(operand1 & operand2);
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::LOG16);
opSub8:
    result = uint16_t(operand1 - operand2);
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::SUB16);
opXor8:
    result = uint16_t(operand1 ^ operand2);
    *WORD(rmAddress) = result;
    return machine.cpu.flagsRegister.set(operand1, operand2, result, FlagsRegister::LOG16);
